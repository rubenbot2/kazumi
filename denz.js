...
try {
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_©Kazumi-Team_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6281235877763-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/CiTQvbBOPHkJQ0bQVYxbOd', "groupName": `${NamaBot}`, "footerText": "*_©Kazumi-Team_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
└─────────────────❒`
sendButLocation(from, `${menu}`, "JAVAICA", {jpegThumbnail:gambar,name:""}, [{buttonId:`owner`,buttonText:{displayText:'👑OWNER'},type:1},{buttonId:`script`,buttonText:{displayText:'📒SCRIPT'},type:1}], {contextInfo: { mentionedJid: [otod]}})
break
case 'command':
 stod = `${sender}`
 listMsg = {
